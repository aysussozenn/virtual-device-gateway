...
/// </summary>
public sealed class CannedBehavior(IReadOnlyDictionary<ushort, DeviceReply> responses) : IDeviceBehavior
{
    private readonly IReadOnlyDictionary<ushort, DeviceReply> _responses = responses;
